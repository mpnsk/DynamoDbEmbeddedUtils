...
public class LocalDynamoDb {
    ...
    public AmazonDynamoDB createClientV1() {
        String endpoint = getEndPoint();
        AwsClientBuilder.EndpointConfiguration endpointConfiguration = new AwsClientBuilder.EndpointConfiguration(endpoint, Region.EU_CENTRAL_1.toString());
